...
void ISOP2P1::buildMatrixStruct()
{
	...
	for (; the_element_p != end_element_p; ++the_element_p)
	{
		...
		for (int j = 0; j < n_element_dof_p; ++j)
		{
			...
			{
				/// 由索引找到对应的速度空间单元.
				Element<double, DIM> &v_element = fem_space_v.element(index_ele_p2v[idx_p][i]);
		...
		for (int j = rowstart[i]; j < rowstart[i + 1]; ++j)
		{
			if (i >= 0 && i < l_i1)
			{
				if (column[j] >= 0 && column[j] < l_j1)
				{
					...
					{
						std::cout << "1. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
				...
				else if (column[j] >= l_j1 && column[j] < l_j2)
				{
					...
					{
						std::cout << "2. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
				...
				else if (column[j] >= l_j2 && column[j] < l_j3)
				{
					...
					{
						std::cout << "3. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
			...
			else if (i >= l_i1 && i < l_i2)
			{
				if (column[j] == i)
				{
					...
					{
						std::cout << "4. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
				...
				else if (column[j] >= 0 && column[j] < l_j1)
				{
					...
					{
						std::cout << "5. Matrix structure error!!" << std::endl;
						exit(-1);
					}
					else
					{
				...
				else if (column[j] >= l_j1 && column[j] < l_j2)
				{
					if (column[j] - l_j1 !=  *column_vyvy)
					{
						std::cout << "6. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
					...
					{
						std::cout << "7. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
			...
			else if (i >= l_i2 && i < l_i3)
			{
				if (column[j] >= 0 && column[j] < l_j1)
					...
					{
						std::cout << "8. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
					...
					{
						std::cout << "9. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
					...
					{
						std::cout << "10. Matrix structure error!" << std::endl;
						exit(-1);
					}
					else
					{
